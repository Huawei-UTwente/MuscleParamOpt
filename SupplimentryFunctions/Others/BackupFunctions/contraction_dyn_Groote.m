...
function [f, df_da, df_dlce, df_ddlce, df_dlce_opt, df_dlt_slack, df_dtheta0]...
         = contraction_dyn_Groote(lmt, a, lce, dlce, lce_opt, lt_slack, theta0)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    dfce_dlce = gaussianFunctionActDiff(lce_nor, b11, b21, b31, b41).*dlce_nor_dlce + ...
        gaussianFunctionActDiff(lce_nor, b12, b22, b32, b42).*dlce_nor_dlce + ...
        gaussianFunctionActDiff(lce_nor, b13, b23, b33, b43).*dlce_nor_dlce;
    
    dfce_dlce_opt = gaussianFunctionActDiff(lce_nor, b11, b21, b31, b41).*dlce_nor_dlce_opt + ...
        gaussianFunctionActDiff(lce_nor, b12, b22, b32, b42).*dlce_nor_dlce_opt + ...
        gaussianFunctionActDiff(lce_nor, b13, b23, b33, b43).*dlce_nor_dlce_opt;
   ...
   [cos_theta, dcos_theta_dlce, dcos_theta_dlce_opt, dcos_theta_dtheta0] ...
        = pennationAngSmooth(lce, lce_opt, theta0);
    ...
    [Fse, dFse_dlce, dFse_dlce_opt, dFse_dtheta0, dFse_dlt_slack] = ...
        tenden_force_Groote(lmt, lce, lce_opt, theta0, lt_slack);
